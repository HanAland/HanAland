public class Switch
{
  ...
  public static double measureRectangle(double length, double width, String option)
  {
    if(length < 0 || width < 0)
    {
      System.out.println("The value of length or width cannot be negative!");
      System.exit(0);
    }
    switch(option)
    {
  ...
  {
    System.out.println("The area of a rectangle with a length " + length + " and width " + width + " is equal to " + measure + "\n");
  }
}